  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      if (isValid) {
        ...
        // You can submit via AJAX here or allow default form submission
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "גיא אורטופדיה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('http://localhost:5001/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '6e7ee1cf-bb68-4144-99e3-09e06c2c85a9',
                    name: data.name || '',
                    email: data.email || '',
